...
public abstract class Conteudo {
    ...
    public Conteudo(String titulo, int duracao, int classficacaoIndicativa) {
        this.titulo = titulo;
        setDuracao(duracao);
        setClassificacaoIndicativa(classficacaoIndicativa);
    }

    public abstract void exibirDetalhes();

    public abstract void reproduzir() {
        System.out.println("Reproduzindo agora: " + this.titulo);
    }
